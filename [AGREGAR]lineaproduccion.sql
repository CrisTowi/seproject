...
--
-- Servidor: localhost
-- Tiempo de generación: 05-05-2013 a las 21:48:14
...
(4, '2', 'RULM910705HDFDPG08', 'pendiente', 4);
...
ALTER TABLE `lineaproduccion`
  ADD CONSTRAINT `lineaproduccion_ibfk_1` FOREIGN KEY (`nolote`) REFERENCES `lote` (`idLote`) ON DELETE CASCADE ON UPDATE CASCADE;
